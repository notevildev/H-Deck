...
public:
    ...
    UIStyle(UIColor foreground, UIColor background, UIColor border_color, uint8_t border_thickness, uint8_t text_size,
            UIBoxSpacing padding)
        : foreground_(foreground), background_(background), border_color_(border_color),
